...
export default class niveau3 extends Phaser.Scene {
  ...
  preload() {
    this.load.image("Phaser_tuilesdejeu2", "src/assets/sprite_opera.png");
    this.load.tilemapTiledJSON("carte2", "src/assets/map_opera.json");
  }
  ...
  create() {
    ...
    const estrade = carteDuNiveau.createLayer("estrade", tileset);
    ...
    this.porte4 = this.physics.add.staticSprite(300, 580, "img_porte4");

    // On créée un nouveeau personnage : player
    player = this.physics.add.sprite(210, 520, "img_perso");
    ...
    estrade.setCollisionByProperty({ estSolide: true });
    this.physics.add.collider(player, estrade);
